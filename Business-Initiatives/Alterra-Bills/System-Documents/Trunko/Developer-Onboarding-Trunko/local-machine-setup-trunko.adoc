= Local Machine Setup Trunko

____
Step by Step installing Trunko in your Local Machine
____

== Prerequisites

=== Version Control System
Version control system (VCS) adalah sistem yang merekam perubahan pada file atau kumpulan file dari waktu ke waktu sehingga Anda dapat _recall_ versi tertentu di kemudian hari jika dibutuhkan. Dalam pengembangannya, Trunko menggunakan https://github.com/[Github] sebagai _versioning control tools_.
...
=== Golang
Trunko adalah sistem yang dikembangkan menggunakan Golang. Golang adalah bahasa pemrograman _open source_ yang dapat dengan mudah digunakan untuk membangun perangkat lunak yang sederhana, _reliable_ dan efisien.
...
Trunko menggunakan *Dep* sebagai _dependency manager_ untuk Golang _development_.
...
=== Trunko Services
Jika Anda sudah mengikuti langkah prasyarat, Anda dapat mulai menginstal Trunko di mesin lokal Anda.
Berikut langkah-langkahnya:

1. Instal <<golang,Golang>>
2. Instal <<version-control-system,Tower>> dan _clone code_ dari _remote url_ https://github.com/sepulsa/trunko
...
13. _Run_ `gin run`
14. _Run_ `./trunko` atau `./trunko start` untuk menjalankan Trunko